...
<div class="bg-gray-50 h-[493px] rounded-md border border-gray-200">
    <img src="{{ asset('storage/' . $novedad->path) }}" alt="{{ $novedad->titulo }}" class="object-cover w-full h-[246px]">
    <div class="p-4 h-[247px] flex flex-col justify-between">
        ...
        <div class="flex gap-6 text-black h-15">
            <a href="{{ route('novedad', ['id' => $novedad->id]) }}" class="hover:underline text-gray-700 mt-8">Leer más</a>
        </div>
    </div>
</div>
