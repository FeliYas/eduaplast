...
<footer class="text-white">
    <div class="bg-main-color ">
        <div class="2xl:flex grid grid-cols-1 lg:grid-cols-2 gap-16 justify-between max-w-[80%] mx-auto py-22">
            ...
            <div>
                ...
                <div class="grid grid-flow-col grid-rows-2 gap-x-20 gap-y-2 mt-4.5 lg:text-sm 2xl:text-[15px]">
            ...
            <div class="flex flex-col gap-4.5">
                ...
                <form id="newsletterForm" class="relative 2xl:w-[300px]">
                    ...
                    <input type="email" name="email" placeholder="Email" required
                        class="bg-transparaten border h-[45px] w-full border-gray-200 px-4 text-sm text-white">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <button type="submit"
                        class="absolute right-0 top-0 h-[45px] w-[45px] flex items-center justify-center  cursor-pointer">
            ...
            <div>
                ...
                <div class="flex flex-col gap-4 items-start text-center justify-center">
    ...
    <div class="bg-main-color border-t border-[#2f3d61]">
        <div class="flex justify-between items-center max-w-[80%] mx-auto py-6 text-xs lg:text-base text-gray-300">
