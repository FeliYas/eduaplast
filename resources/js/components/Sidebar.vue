<template>
  <div class="p-3 flex flex-col bg-main-color h-screen fixed overflow-hidden transition-all duration-300 shadow-lg z-9"
    ...
    <div class="flex-grow">      <div
      ...
      <!-- Secciones -->
      <div class="max-h-[calc(100vh-250px)] overflow-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
...
export default {
  ...
  methods: {
    async toggleSubmenu(submenuId) {
      ...
      if (submenuId === 'zonaSubmenu' && this.$refs.zonaSubmenu) {
