...
<template>
        ...
        <div class="group relative h-full">
            ...
            <div class="w-full flex flex-col gap-8 py-4">
                ...
                <div class="flex flex-col md:flex-row gap-8 bg-gray-50 py-8 px-4 mb-10 rounded-xl shadow-md border border-gray-200">
                    <TarjetaNosotros 
                        :imagen="nosotros.imagen1" 
                        :titulo="nosotros.titulo1" 
                        :descripcion="nosotros.descripcion1" 
                        :id="nosotros.id" 
                        :num="1" 
                    />
                    <TarjetaNosotros 
                        :imagen="nosotros.imagen2" 
                        :titulo="nosotros.titulo2" 
                        :descripcion="nosotros.descripcion2" 
                        :id="nosotros.id" 
                        :num="2" 
                    />
                    <TarjetaNosotros 
                        :imagen="nosotros.imagen3" 
                        :titulo="nosotros.titulo3" 
                        :descripcion="nosotros.descripcion3" 
                        :id="nosotros.id" 
                        :num="3" 
                    />
                </div>
