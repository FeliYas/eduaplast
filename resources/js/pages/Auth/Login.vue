...
<template>
  ...
  <div class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="z-10">
      <a :href="route('home')" class="back-link flex absolute top-4 left-4 text-main-color px-4 py-2 outline-none hover:underline">
        <i class="fa-solid fa-arrow-left mr-2 p-1" style="color: #374977;"></i>Volver al Home
      </a>
      <div>
